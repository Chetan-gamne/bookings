...
// return True if Availabilty exist for roomID else False
...
// SearchAvailabiltyForAllRooms returns slice of available rooms, if any for given data range
...
func (m *postgresDBRepo) UpdateUser(u models.User) error {
	...
	query := `
		update users set first_names = $1,last_name = $2, email= $3, access_level = $4, updated_at = $5
	`
...
// UpdateProcessedForReservation for ID
...
// GetRestrictionsForRoomByDate return restrictions on Room By Date Range
